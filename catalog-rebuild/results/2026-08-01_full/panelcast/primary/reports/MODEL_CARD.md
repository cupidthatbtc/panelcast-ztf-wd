# Model Card: Ztf Wd Catalog Monthly source_id Score Prediction Model

## Model Details

- **Model type:** Bayesian Hierarchical Regression with Time-Varying Effects
- **Version:** 0.23.0
- **Authors:** Ztf Wd Catalog Monthly Prediction Pipeline
- **Created:** 2026-08-02
...
- **Dataset:** ztf_wd_catalog_monthly
- **Size:** 49,422 albums
- **Description:** Sequential month id-level records grouped by source id from the 'ztf_wd_catalog_monthly' dataset, with the target score (mag_binned) bounded to [10, 20].
...
**Prior Predictive Check**: Prior predictive simulation (n_samples=500) shows 77.7% of prior-implied predictions fall within [10.0, 20.0]. Summary: mean=16.0, sd=3.6, range=[9.5, 20.5].
...
- 80% CI: 78.7% empirical coverage, mean width=0.07
- 95% CI: 92.8% empirical coverage, mean width=0.13

**Posterior Predictive Checks:**
- mean: T(y_obs)=16.91, p=0.781 (MC SE: 0.004)
- sd: T(y_obs)=0.89, p=0.082 (MC SE: 0.003)
- skewness: T(y_obs)=-1.27, p=0.509 (MC SE: 0.005)
- min: T(y_obs)=12.81, p=0.161 (MC SE: 0.003)
- max: T(y_obs)=18.94, p=0.002 (MC SE: 0.000)
- q10: T(y_obs)=15.64, p=0.894 (MC SE: 0.003)
- q50: T(y_obs)=17.12, p=0.820 (MC SE: 0.004)
- q90: T(y_obs)=17.82, p=0.880 (MC SE: 0.003)
...
| n_reviews_decile | (0.999, 2.0] | 329 | 0.95 | 0.851 | [0.809, 0.885] |
| n_reviews_decile | (5.0, 6.0] | 94 | 0.80 | 0.894 | [0.815, 0.941] |
| n_reviews_decile | (7.0, 8.0] | 125 | 0.80 | 0.888 | [0.821, 0.932] |
| n_reviews_decile | (9.0, 26.0] | 57 | 0.80 | 0.965 | [0.881, 0.990] |
| train_history | 11+ | 903 | 0.95 | 0.930 | [0.912, 0.945] |
| target_tercile | (12.809000000000001, 16.69] | 310 | 0.80 | 0.906 | [0.869, 0.934] |
| target_tercile | (17.436, 18.94] | 309 | 0.80 | 0.663 | [0.609, 0.714] |
| target_tercile | (17.436, 18.94] | 309 | 0.95 | 0.874 | [0.832, 0.906] |
...
# Load the current ztfgc-score model referenced by models/manifest.json
manifest = load_manifest(Path("models"))
model_name = manifest.current["ztfgc_score"]
...
n_features = int(posterior_samples["ztfgc_beta"].shape[-1])
